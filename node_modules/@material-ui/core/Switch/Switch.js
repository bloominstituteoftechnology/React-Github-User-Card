...
var Switch = _react.default.forwardRef(function Switch(props, ref) {
  ...
  return _react.default.createElement("span", {
    ...
    checkedIcon: icon,
    classes: {
      root: (0, _clsx.default)(classes.switchBase, classes["color".concat((0, _helpers.capitalize)(color))]),
      input: classes.input,
