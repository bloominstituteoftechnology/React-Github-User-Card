...
var LinearProgress = _react.default.forwardRef(function LinearProgress(props, ref) {
  ...
  if (variant === 'determinate' || variant === 'buffer') {
    if (value !== undefined) {
      ...
      process.env.NODE_ENV !== "production" ? (0, _warning.default)(false, 'Material-UI: you need to provide a value prop ' + 'when using the determinate or buffer variant of LinearProgress .') : void 0;
    }
  }
  ...
  if (variant === 'buffer') {
    if (valueBuffer !== undefined) {
      ...
      process.env.NODE_ENV !== "production" ? (0, _warning.default)(false, 'Material-UI: you need to provide a valueBuffer prop ' + 'when using the buffer variant of LinearProgress.') : void 0;
    }
  }
