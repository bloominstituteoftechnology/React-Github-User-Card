...
const defaultCheckedIcon = React.createElement(CheckBoxIcon, null);
const defaultIcon = React.createElement(CheckBoxOutlineBlankIcon, null);
const defaultIndeterminateIcon = React.createElement(IndeterminateCheckBoxIcon, null);
