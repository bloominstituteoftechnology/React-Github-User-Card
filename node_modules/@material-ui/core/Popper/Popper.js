...
var Popper = _react.default.forwardRef(function Popper(props, ref) {
  ...
  var ownRef = (0, _reactHelpers.useForkRef)(tooltipRef, ref);

  var popperRef = _react.default.useRef(null);

  var handlePopperRef = (0, _reactHelpers.useForkRef)(popperRef, popperRefProp);
  ...
  var handleOpen = _react.default.useCallback(function () {
    ...
    var popper = new _popper.default(getAnchorEl(anchorEl), popperNode, (0, _extends2.default)({
      ...
      onUpdate: (0, _helpers.createChainedFunction)(handlePopperUpdate, popperOptions.onUpdate)
    }));
    handlePopperRefRef.current(popper);
  }, [anchorEl, disablePortal, modifiers, open, rtlPlacement, popperOptions]);

  var handleRef = _react.default.useCallback(function (node) {
    (0, _reactHelpers.setRef)(ownRef, node);
    handleOpen();
  }, [ownRef, handleOpen]);
...
process.env.NODE_ENV !== "production" ? Popper.propTypes = {
   ...
   */
  popperRef: _propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.object]),
