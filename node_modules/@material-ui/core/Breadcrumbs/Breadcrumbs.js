...
var Breadcrumbs = _react.default.forwardRef(function Breadcrumbs(props, ref) {
  ...
  var renderItemsBeforeAndAfter = function renderItemsBeforeAndAfter(allItems) {
    ...
    if (itemsBeforeCollapse + itemsAfterCollapse >= allItems.length) {
      process.env.NODE_ENV !== "production" ? (0, _warning.default)(false, ['Material-UI: you have provided an invalid combination of props to the Breadcrumbs.', "itemsAfterCollapse={".concat(itemsAfterCollapse, "} +itemsBeforeCollapse={").concat(itemsBeforeCollapse, "} >= maxItems={").concat(maxItems, "}")].join('\n')) : void 0;
      return allItems;
    }
