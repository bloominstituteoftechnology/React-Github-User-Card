...
function IconContainer(props) {
  ...
  return _react.default.createElement("div", other);
}
...
var Rating = _react.default.forwardRef(function Rating(props, ref) {
  ...
  var handleMouseMove = function handleMouseMove(event) {
    ...
    if (theme.direction === 'rtl') {
      percent = (right - event.pageX - (0, _utils2.ownerWindow)(rootNode).pageXOffset) / (width * max);
    } else {
      percent = (event.pageX - left - (0, _utils2.ownerWindow)(rootNode).pageXOffset) / (width * max);
    }

    var newHover = roundValueToPrecision(max * percent, precision);
